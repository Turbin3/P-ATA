...
use crate::create_idempotent::process_create_idempotent_instruction;
...
pub fn process_instruction(
    ...
    match AssociatedTokenAccountInstruction::try_from_bytes(instruction_data)? {
        ...
        AssociatedTokenAccountInstruction::CreateIdempotent => process_create_idempotent_instruction(program_id, accounts, instruction_data),
        AssociatedTokenAccountInstruction::RecoverNested => todo!(),
    }
}
